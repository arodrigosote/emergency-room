...
def listar_visitas():
    ...
    cursor = conn.cursor()
    cursor.execute('SELECT id_visita, folio, motivo, id_paciente, id_doctor, id_sala, id_cama, id_trabajador_social, fecha_entrada, fecha_salida, estado FROM visitas_emergencia')
